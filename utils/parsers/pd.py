...
# local libs
from _config.global_slots import YAML_MICROSOFT_APPS
from utils.cals.handling_dates import DatesBR
from utils.loggs.create_logs import CreateLog
from utils.parsers.folders import DirFilesManagement

# check if this is a windows machine
if os.name == "nt":
    from utils.microsoft_apps.excel import DealingExcel
